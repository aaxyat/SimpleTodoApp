...
@app.get("/api/todo/{todo_id}", status_code=status.HTTP_200_OK)
...
@app.post("/api/todo/create", status_code=status.HTTP_201_CREATED)
...
@app.put("/api/todo/update/{todo_id}", status_code=status.HTTP_204_NO_CONTENT)
